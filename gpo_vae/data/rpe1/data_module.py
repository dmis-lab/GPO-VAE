...
class RPE1DataModule(PerturbationDataModule):
    def __init__(
        self,
        # deprecated argument
        data_key: Optional[
        ...
        if 'qc' not in data_path:
            ...
            if stat_path is not None:
                summary_stats_rpe1 = pd.read_excel(stat_path, sheet_name='TabC_RPE1_summary_statistic')
                # remove week perturbation gene and week perturbed cell
                strong_perts = get_strong_perts(summary_stats_rpe1) + ['non-targeting']
...
def get_ctrl_pair_annotation(adata_origin, anno="matched_ctrl_idx", mode="ot"):
    ...
    adata_origin.write_h5ad(f"./datasets/rpe1_qc_deg_{anno}_{mode}.h5ad")
