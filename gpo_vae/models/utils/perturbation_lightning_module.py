...
from gpo_vae import data, models
from gpo_vae.data.utils.perturbation_dataset import PerturbationDataSample
from gpo_vae.models.utils.loss_modules import PerturbationPlatedELBOLossModule
...
class TrainConfigPerturbationLightningModule(PerturbationLightningModule):
    ...
    def _init_guide(self):
        ...
        kwargs["fc_criteria"] = self.config["loss_module_kwargs"]["fc_criteria"]
