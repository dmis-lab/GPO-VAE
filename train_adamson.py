...
def get_callbacks(results_dir: str, data_module: PerturbationDataModule):
    ...
    mask_stats_callback = TreatmentMaskStatsTracker(
        ...
        wd_np_train=data_module.adata.uns['matched_ctrl_idx_0_wd_train'],
        wd_np_test=data_module.adata.uns['matched_ctrl_idx_0_wd_test'],
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default='./demo/gpo_vae_adamson.yaml', # './demo/gpo_vae_adamson.yaml' , None
    )
